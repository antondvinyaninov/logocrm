<x-home-layout>
                    ...
                    @if(auth()->user()->role !== 'parent')
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="anamnesis" id="anamnesis" rows="4"
                                      class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('anamnesis') border-red-500 @enderror">{{ old('anamnesis', $child->anamnesis) }}</textarea>
                            @error('anamnesis')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="goals" id="goals" rows="4"
                                      class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 @error('goals') border-red-500 @enderror">{{ old('goals', $child->goals) }}</textarea>
                            @error('goals')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
    ...
    @if(auth()->user()->role !== 'parent')
        <script>
            let tags = @json(old('tags', $child->tags ?? []));
