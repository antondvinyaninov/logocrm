<x-home-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('leads.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900">
                ← Назад к списку
            </a>
        </div>
    </x-slot>
        ...
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <!-- Заметки -->
                    <div class="mb-6">
                        <h4 class="mb-2 text-sm font-semibold text-gray-700">Заметки специалиста</h4>
                    ...
                    <!-- Удаление убрано - только специалисты обрабатывают, не удаляют -->
                </div>
            </div>
        </div>
    </div>
