                ...
                <form method="POST" action="{{ route('admin.users.update', $user) }}" class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="role" id="role" 
                            ...
                            <option value="superadmin" {{ old('role', $user->role) === 'superadmin' ? 'selected' : '' }}>Суперадмин</option>
                            <option value="organization" {{ old('role', $user->role) === 'organization' ? 'selected' : '' }}>Владелец центра</option>
